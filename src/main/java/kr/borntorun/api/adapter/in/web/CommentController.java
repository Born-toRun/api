...
public class CommentController {
  ...
  public void create(@AuthUser TokenDetail my, @PathVariable long feedId, @RequestBody @Valid CreateCommentRequest request) {
  ...
  public ResponseEntity<ModifyCommentResponse> modify(@AuthUser TokenDetail my, @PathVariable long commentId, @RequestBody @Valid ModifyCommentRequest request) {
