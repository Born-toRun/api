...
public class AuthorizationFilter extends AbstractPreAuthenticatedProcessingFilter {
	...
	public AuthorizationFilter(final JwtDecoder jwtDecoder,
	  final SystemAuthenticationProvider systemAuthenticationProvider) {
			...
			try {
				...
				if (authorities instanceof List) {
					SecurityContextHolder.getContext()
					  .setAuthentication(new JwtAuthenticationToken(jwt, ((List<?>)authorities).stream()
