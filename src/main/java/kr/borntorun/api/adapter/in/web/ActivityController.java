...
public class ActivityController {
	...
	public void modify(@AuthUser TokenDetail my, @PathVariable long activityId,
	  @RequestBody @Valid ModifyActivityRequest request) {
	...
	public void attendance(@AuthUser TokenDetail my, @PathVariable long activityId,
	  @RequestBody @Valid AttendanceActivityRequest request) {
